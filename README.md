...
- Visualizer - Generates summaries and creates interactive HTML visualizer from results
- PbixVisualizer - PowerBI-based alternative visualizer (not yet implemented).
