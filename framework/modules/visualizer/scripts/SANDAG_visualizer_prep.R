...
### Updated by: Ilona Regan, August 2022
#######################################################
start_time = Sys.time()
...
if(length(args) > 0){
  ...
  settings_file = 'C:/Users/ilona.regan/Git/TMRScripts/SANDAG/Tour_Table/survey_data_processing/sandag_inputs.yml'
}
...
zones = st_read(file.path(zone_dir, "SANDAG_TAZ.shp"))
...
write.csv(hh, "C:/Users/ilona.regan/Resource Systems Group, Inc/Transportation MR - Documents/22034_SANDAG_HTS/Internal/4.DataAnalysis/1.Data/TourTableData/survey_data/proc_survey_files/hh.csv")
write.csv(per, "C:/Users/ilona.regan/Resource Systems Group, Inc/Transportation MR - Documents/22034_SANDAG_HTS/Internal/4.DataAnalysis/1.Data/TourTableData/survey_data/proc_survey_files/per.csv")
write.csv(tourDays, "C:/Users/ilona.regan/Resource Systems Group, Inc/Transportation MR - Documents/22034_SANDAG_HTS/Internal/4.DataAnalysis/1.Data/TourTableData/survey_data/proc_survey_files/tour.csv")
write.csv(trips, "C:/Users/ilona.regan/Resource Systems Group, Inc/Transportation MR - Documents/22034_SANDAG_HTS/Internal/4.DataAnalysis/1.Data/TourTableData/survey_data/proc_survey_files/trips.csv")
...
# workers = per[(PERTYPE<=3 | PERTYPE==6) & empl_loc_type!=2, c("SAMPN", "PERNO", "empl_loc_type","PERTYPE", "finalweight")]
...
per_raw[, person_id := as.double(person_id)]
...
# COMMENTING OUT 9/7 NO SKIMS OR TAZ
